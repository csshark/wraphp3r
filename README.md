...
<b>Refactor:</b> Tool has been refactored to version 2.0. Please use <code>-h</code> flag to use new functions.
...
```
## Example usage:
<pre><code>python3 wraphp3r.py http://example.com/test.php file</code></pre>
